...
import {
  ...
  ListPagesSchema, CreatePageSchema, DeletePageSchema,
  ListMediaSchema, UpdateMediaSchema,
  ListCommentsSchema, CreateCommentSchema,
  ListCategoriesSchema, CreateCategorySchema, DeleteCategorySchema,
  ListTagsSchema, CreateTagSchema,
  ListUsersSchema, CreateUserSchema, DeleteUserSchema, CreateAppPasswordSchema,
  ListCustomPostsSchema, CreateCustomPostSchema,
  ListMenusSchema, CreateMenuSchema, CreateMenuItemSchema,
  ListPluginsSchema, UpdatePluginSchema,
  SearchSchema,
  ListBlockTypesSchema, GetBlockTypeSchema, RenderBlockSchema,
  ListWidgetsSchema, CreateWidgetSchema,
  ListNavigationsSchema, CreateNavigationSchema,
  GetSettingsSchema, UpdateSettingsSchema,
